...
class ImageUtils {
  ...
  static Future<Image> mergeImage(List<AssetEntity> images, String imageName) async {
  ...
  static Future<void> markImage(List<AssetEntity> images, Image water, StreamController streamController) async {
  ...
  static addTextToImage(Image image, Image water) async {
    ...
    var wateredImg = Package_img.drawImage(img!, imgWM!, dstX: 50,dstY: (img.height*0.6).toInt(),dstH: imgWM.height*3,dstW: imgWM.width*3,srcX: 0,srcY: 0,srcH: imgWM.height,srcW: imgWM.width);

    return ImagesMergeHelper.uint8ListToImage(Uint8List.fromList(imgEncoder.encodeImage(wateredImg)));
  }
